...
The third surprising thing was when Teresa Domaszewska, my student at that
time, tried to reproduce the findings of both papers. Our idea was, you
see, that evolutionarily speaking, the lineages leading to mice and humans
...
give you another example. I have prepared a little dataset, stored as Excel
file and available for download from
[github](https://github.com/bihealth/howtotalk-book/raw/b9ea8c9e035b569fb9c5998f312ac2946f9e0868/scripts/iris.xlsx)[^iris].
...
does not have to be as visible as that in the final doucument.:
